    ...
    <article>
        ...
        <section class="section featured " id="FEATURED-COLLECTION" aria-label="featured collection">
            <div class="container">
                ...
                <div class="container">
                    <div class="shop">
                        <div class="box d-flex" style="width: 400px">
                            <img src="./assets/images/romance.jpeg" style="height: 185px;">
                            <div class="content ms-5 d-flex">
                                <div>
                                <h3 style="margin-top: 20px">Women Lipsticks</h3>
                                <h4 style="margin-top: 20px">Price: $40</h4>
                                <p style="margin-top: 20px" class="unit">Quantity: <input name="" value="2"></p>
                                </div>
                                <div>
                                    <button class="submit btn btn-primary"
                                            style="padding: 2px 2px; display: flex; flex-direction: row; border-radius: 0; margin-top: 35px; "
                                            id="btnSubmit"> Purches
                                    </button>
